...
% An example to rerefence the own address data is shown in DEMO-rechnung-zugferd-Kleinunternehmen.tex.
% See documentation for details.
% This should be configured without your own zugferd-invoice package variant.

\begin{document}

\begin{letter}{\InsertZUGFeRDData[AddressData]{buyer}}% Please be aware that this does not print the Country, as this is only available via the Countrycode in this implementation
